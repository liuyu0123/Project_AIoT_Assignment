...
package_share_dir = get_package_share_directory('camera_driver')
...
left_camera_matrix, left_distortion, right_camera_matrix, right_distortion, R, T, \
    left_map1, left_map2, right_map1, right_map2, b, f, cx, cy = load_camera_config(camera_config_path)
