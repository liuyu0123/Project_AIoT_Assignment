...
def generate_launch_description():
    ...
    yolov5_detector = Node(
        ...
        # parameters=[{'model_path': '/home/nvidia/Documents/LIUYU/WelaBoat_ws/src/perception/yolov5_detector/model/yolov5s.pt'}],
    ...
    fastscnn_segmenter_water = Node(
        ...
        parameters=[{
            ...
            # 'model_path': '/home/nvidia/Fast-SCNN-pytorch/weights/fast_scnn_water.pth',
